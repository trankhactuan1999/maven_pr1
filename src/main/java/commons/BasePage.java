...
//		alert.accept();
	...
	public void clickToLoginButton(WebDriver driver) {
		waitForElementClickable(driver, BasePaseUI.LOGIN_BUTTON);
		clickToElement(driver, BasePaseUI.LOGIN_BUTTON);
	}

	public void enterTextboxByName(WebDriver driver, String nameField, String value) {
		waitForElementVisible(driver, BasePaseUI.FIELD_TEXTBOX_BY_NAME,	nameField);
		sendkeyToElement(driver, BasePaseUI.FIELD_TEXTBOX_BY_NAME,value, nameField);
	}

	public boolean isMessageDisplayedByNameField(WebDriver driver, String nameField, String messageValue) {
		waitForElementVisible(driver, BasePaseUI.FIELD_TEXTBOX_BY_NAME, nameField);
		return isElementDisplayed(driver, BasePaseUI.MESSAGE_TEXT, messageValue);
	}

	public void clickToLoginButtonOnPopup(WebDriver driver) {
		waitForElementClickable(driver, BasePaseUI.LOGIN_BUTTON_ON_POPUP);
	...
	public void clickToBackButton(WebDriver driver) {
		waitForElementClickable(driver,BasePaseUI.BACK_BUTTON);
